...
await Deno.writeTextFile("HanuCardCreator/public/poseUrl.js", `const poseUrl = [ "${listOfFiles.join('", "')}"]`)
...
app.post("/cards", async c => {
    ...
    console.log(body)
    await Deno.writeTextFile("HanuCardCreator/public/hanucards.json", JSON.stringify(body))
